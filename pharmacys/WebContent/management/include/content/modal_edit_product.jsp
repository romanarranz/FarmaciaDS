    ...
    <div class="modal-content">
    	...
    	<div class="modal-header">
      	...
      	<div class="modal-body">
        	<div class="row">		         	
        		<div class="col-md-5">
        			<img src="http://10.211.55.6/img/products/img_no_aviable.png" style="width: 100%; height: 300px;" alt=""/>
          		...
          		<div class="col-md-7">          			          			
  					...
  					<div class="form-group row">
    					<label for="editLaboratory" class="col-sm-4">Laboratory</label>
   						<div class="col-sm-8">
      						<input type="text" class="form-control" id="editLaboratory">
    					</div>
  					</div>
					<!-- Units -->
  					<div class="form-group row">
    					<label for="editUnits" class="col-sm-4">Units</label>
   						<div class="col-sm-8">
   							<input type="text" class="form-control" id="editUnits">
   						</div>
  					</div>
  					<!-- Expiration Date -->
  					<div class="form-group row">
  						...
  						<div class="col-sm-8">
  							<input type="date" class="form-control" id="editExpDate">
    					</div>
  					</div>			
  					<!-- Size -->
  					<div class="form-group row">
    					<label for="editSize" class="col-sm-4">Size</label>
   						<div class="col-sm-8">
      						<input type="number" class="form-control" id="editSize">
    					</div>
  					</div>
  					<!-- Lot -->
  					<div class="form-group row">
    					<label for="editLot" class="col-sm-4">Lot</label>
   						<div class="col-sm-8">
      						<input type="text" class="form-control" id="editLot">
    					</div>
  					</div>					
          		</div>
          	    ...
          	    <div class="col-md-12" style="margin-top: 10px">					
    				<label class="control-label">Description</label>
   					<div class="col-sm-12" style="padding: 0">
      					<textarea name="editDescr" class="form-control" rows="5"></textarea>
    				</div>
  				</div>
        	</div>
      	</div>
