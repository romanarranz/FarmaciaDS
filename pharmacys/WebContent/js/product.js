$('#edit').on('show.bs.modal', function (event) {
	...
	$.ajax({
		...
		success: function(jsondata){
			...
			modal.find('#editName').val(jsondata.name);
			modal.find('#editLaboratory').val(jsondata.laboratory);
			modal.find('#editCategory').val(jsondata.category);
			...
			modal.find('#editDescr').val(jsondata.description);
		},
